	 ...
	 public class Actions 
	 {
		 ...
		 static WebDriver driver;
		 	...
		 	public static void AddNationality() throws Exception
			{
				...
				findElement(By.id("nationality_name")).sendKeys("Mexican794");
			 ...
			 @Test 
			 	public static void AddLocations() throws Exception
				{
					...
					Reporter.log("Add Locations Excecution");
				}
			  ...
			  public static void AddSkills() throws Exception
			  {
				...
				findElement(By.id("btnAdd")).click();
				findElement(By.id("skill_name")).sendKeys("Selenium4");
				findElement(By.id("skill_description")).sendKeys("Selenium Decsription4");
				findElement(By.id("btnSave")).click();
			  }
